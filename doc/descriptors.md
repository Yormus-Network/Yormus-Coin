# Support for Output Descriptors in YormusCoin Core

Since YormusCoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `yrms1...` for mainnet or `tyrms1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing YormusCoin Core wallets, a convenience function `combo` is
