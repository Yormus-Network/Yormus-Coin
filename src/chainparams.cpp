...
{
    const char* pszTimestamp = "Donald John Trump was born June 14 1946";
    const CScript genesisOutputScript = CScript() << ParseHex("041a1bee1ee9bb6f3ab10e2fc63e78e17509a1998018edf2e20246a40c574773cf32d3eb4287a11a1fd3195f1f776b76481f5b6962311e100dd368915bc9a9f38e") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xcbd2ab3d738608c49b2a544fc5db33c7bf836ad67a70450dcccda2cd9d82b045"); 
        ...
        genesis = CreateGenesisBlock(1712970686, 702519, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xcbd2ab3d738608c49b2a544fc5db33c7bf836ad67a70450dcccda2cd9d82b045"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f713b5d55355f6b895702d2a718d1cf010f7a4efaa153a2702ab3154d126b05"));
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,79);
        ...
        checkpointData = {
            {
                {  0, uint256S("0xcbd2ab3d738608c49b2a544fc5db33c7bf836ad67a70450dcccda2cd9d82b045")},
            }
        };

        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats 4096 cbd2ab3d738608c49b2a544fc5db33c7bf836ad67a70450dcccda2cd9d82b045
            /* nTime    */ 1712970686,
            /* nTxCount */ 0,
            /* dTxRate  */ 0
        };
...
public:
    CTestNetParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0xa851d9c6e2cd9ddfbd7f9d3266d4b3edc09c5f93e3c6090fdaa6ede6e54c4c3b"); 
        ...
        genesis = CreateGenesisBlock(1712970848, 1685290, 0x1e0ffff0, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa851d9c6e2cd9ddfbd7f9d3266d4b3edc09c5f93e3c6090fdaa6ede6e54c4c3b"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f713b5d55355f6b895702d2a718d1cf010f7a4efaa153a2702ab3154d126b05"));
        ...
        checkpointData = {
            {
                {0, uint256S("a851d9c6e2cd9ddfbd7f9d3266d4b3edc09c5f93e3c6090fdaa6ede6e54c4c3b")},
            }
        };

        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 a851d9c6e2cd9ddfbd7f9d3266d4b3edc09c5f93e3c6090fdaa6ede6e54c4c3b
            /* nTime    */ 1712970848,
            /* nTxCount */ 0,
            /* dTxRate  */ 0,
        };
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1712971224, 0, 0x207fffff, 1, 150 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf984322ec681bdf4d632ae473c27c6dd9696660f853fe2e0097e073d7735be3e"));
        assert(genesis.hashMerkleRoot == uint256S("0x2f713b5d55355f6b895702d2a718d1cf010f7a4efaa153a2702ab3154d126b05"));
        ...
        checkpointData = {
            {
                {0, uint256S("f984322ec681bdf4d632ae473c27c6dd9696660f853fe2e0097e073d7735be3e")},
            }
        };
