...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " yormuscoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  yormuscoin-tx [options] <hex-tx> [commands]  Update hex-encoded yormuscoin transaction\n" +
            "or:     yormuscoin-tx [options] -create [commands]   Create hex-encoded yormuscoin transaction\n" +
            "\n";
