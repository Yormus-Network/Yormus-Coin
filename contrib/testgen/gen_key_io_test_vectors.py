...
bech32_templates = [
  ...
  ('yrms',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('yrms',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('yrms',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('yrms',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tyrms',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tyrms',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tyrms',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tyrms',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tyrms',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tyrms',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tyrms',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tyrms',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('ryrms',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('ryrms',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('ryrms',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('ryrms', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tyrms',   17, 32, Encoding.BECH32M, False, False, False),
  ('ryrms',  3,  1, Encoding.BECH32M, False, False, False),
  ('yrms',   15, 41, Encoding.BECH32M, False, False, False),
  ('tyrms',    0, 16, Encoding.BECH32,  False, False, False),
  ('ryrms',  0, 32, Encoding.BECH32,  True,  False, False),
  ('yrms',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tyrms',    0, 32, Encoding.BECH32,  False, True,  False),
  ('ryrms',  0, 20, Encoding.BECH32,  False, False, True),
  ('yrms',    0, 20, Encoding.BECH32M, False, False, False),
  ('tyrms',    0, 32, Encoding.BECH32M, False, False, False),
  ('ryrms',  0, 20, Encoding.BECH32M, False, False, False),
  ('yrms',    1, 32, Encoding.BECH32,  False, False, False),
  ('tyrms',    2, 16, Encoding.BECH32,  False, False, False),
  ('ryrms', 16, 20, Encoding.BECH32,  False, False, False),
]
