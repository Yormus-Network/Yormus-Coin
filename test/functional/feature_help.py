...
"""Verify that starting yormuscoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start yormuscoin with -h for help text")
        ...
        self.log.info("Start yormuscoin with -version for version information")
        ...
        self.log.info("Start yormuscoind with -fakearg to make sure it does not start")
