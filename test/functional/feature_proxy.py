...
"""Test yormuscoind with different proxy configuration.

Test plan:
- Start yormuscoind's with different proxy configurations
- Use addnode to initiate connections
- Verify that proxies are connected to, and the right connection command is given
- Proxy configurations to test on yormuscoind side:
