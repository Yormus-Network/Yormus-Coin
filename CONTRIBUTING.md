Contributing to YormusCoin Core
============================

The YormusCoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the YormusCoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/yormuscoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to yormuscoin-qt
...
The following applies to code changes to the YormusCoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall YormusCoin
Network Protocol consensus changes.

Whether a pull request is merged into YormusCoin Core rests with the project merge
...
Patches that change YormusCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the YormusCoin consensus, it must have been
...
The project leader is the release manager for each YormusCoin Core release.
